...
st.divider()
st.header("Explore the web application 🧑‍🚀")

st.subheader("You want to start with the 'About' page first to understand what our work is about 🤓")
st.write("")
...
st.write(
redirect_button("http://localhost:8501/About", "About"),
redirect_button("http://localhost:8501/DDI", "DDI Checker"),
)
